function [score,operations,matrix ] = scoreMatrix(s,s1,match,mismatch,gap,mode )
%{
This function calculates the score for a chosen mode,creates a score
...
array of operations, matrix- the generated score matrix; mode: 1=distnace, 2=similarity .
%}
n = length(s);
m = length(s1);
matrix = zeros(n,m);

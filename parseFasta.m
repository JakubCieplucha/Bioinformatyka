%{
This function transforms a text in the Fasta format into a struct, containig the identifier
and the sequence of the Fasta content.
Input parameter: text- the Fasta content.
Output parameter: s- the generated struct.
%}
